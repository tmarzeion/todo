    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `todos_table` (`id` INTEGER NOT NULL, `title` TEXT NOT NULL, `completed` INTEGER NOT NULL, PRIMARY KEY (`id`))');
...
class _$TodoDao extends TodoDao {
  ...
  Future<List<Todo>> getAllTodos() async {
    return _queryAdapter.queryList('SELECT * FROM todos_table',
